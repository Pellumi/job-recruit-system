  ...
  return (
    <>
      ...
      <div className="min-h-screen md:px-20 px-3  pt-14 flex text-white bg-gray-950">
        <div className="  w-full  flex  pt-28 flex-col justify-start  items-center relative gap-4">
          <div className="bg-[url('/images/JobData/45.jpg')] w-full bg-cover bg-no-repeat opacity-20 bg-center absolute top-0 h-[500px]"></div>
          <div className="flex md:flex-row flex-col items-center justify-center relative z-10 md:gap-10 gap-1">
          ...
          <div className="mt-[9rem] pt-[8rem] md:px-[1rem] px-[0rem] w-full">
