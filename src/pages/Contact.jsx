    ...
    <>
      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          <div>
            <p className="text-4xl mb-3 pb-3 underline underline-offset-8 underPur font-bold text-center">
              Contact Us
            </p>
          ...
          <div>
            ...
            <Card
              title="Address"
              content="JobLane, BUCodel, Babcock University, ilishan-Remo, Nigeria"
            />
            <Card
              title="Email"
              content={[
                "General Inquiries: abiakamkamsiyo@gmail.com",
                "Support: abiakamkamsiyo@gmail.com",
                "Job Applications: abiakamkamsiyo@gmail.com",
              ]}
            />
            <Card
              title="Phone"
              content={[
                "Customer Support: 09138411139",
                "HR & Job Inquiries: 09138411139",
              ]}
            />
          ...
          <div>
            ...
            <Accordion
              question="How does JobLane Work?"
              answer="You contact us with the job offer you wish to enlist and then we upload the job offer to our users, the users then search for job offers that suit them and they can apply for the job offers. We then forward all applications to you and you send your feedback which we forward to the users."
            />
            <Accordion
