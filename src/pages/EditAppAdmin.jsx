      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        {loading ? (
          ...
          <div>
            ...
            <div className="py- md:pt-3 pt-12 text-2xl md:text-4xl">
              Application #{id}
            </div>
              ...
              <div>
                <ul>
                  <li className="flex gap-4 items-center">
                    Role: <div>{applicationData.job.title}</div>
                  </li>
                  <li className="flex gap-4 items-center">
                    Company: <div>{applicationData.job.companyName}</div>
                  </li>
                  <li className="flex gap-4 items-center">
                    Location: <div>{applicationData.job.location}</div>
                  </li>
                  <li className="flex gap-4 items-center">
                    Experience: <div>{applicationData.job.experience}</div>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="pt-4 pb-6">
              ...
              <div>
                <ul>
                  <li className="flex gap-4 items-center">
                    Name: <div>{applicationData.applicant.name}</div>
                  </li>
                  <li className="flex gap-4 items-center">
                    Email: <div>{applicationData.applicant.email}</div>
                  </li>
                  <li className="flex gap-4 items-center">
                    Resume:{" "}
                    <Link
              ...
              <div className="flex gap-4">
                <div>
                  <select
                    ...
                    id="large"
                    class="block w-full px-6 py-3 text-base  border bg-gray-900 border-gray-600 placeholder-gray-400 text-white "
                  >
                    <option value="not" selected>
                      Select Status
                    </option>
                    <option value="interview">Grant Interview</option>
